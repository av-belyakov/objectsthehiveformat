...
func NewTtpsMessage() *Ttps {
	return &Ttps{
		Ttp: []TtpMessage(nil),
	}
}

func (ttps *Ttps) SetTtps(list []TtpMessage) {
	ttps.Ttp = list
}

func (ttps *Ttps) GetTtps() []TtpMessage {
	return ttps.Ttp
}

func (ttps *Ttps) Set(v TtpMessage) {
...
func (ttpm *TtpMessage) SetAnyOccurDate(i any) {
...
func (ttpm *TtpMessage) SetAnyUnderliningCreatedAt(i any) {
	tmp := supportingfunctions.ConversionAnyToInt(i)
...
func (ttpm *TtpMessage) SetAnyUnderliningId(i any) {
...
func (ttpm *TtpMessage) SetAnyUnderliningCreatedBy(i any) {
...
func (ttpm *TtpMessage) SetAnyPatternId(i any) {
...
func (ttpm *TtpMessage) SetAnyTactic(i any) {
