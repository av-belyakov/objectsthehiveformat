...
// NewEventCaseDetails создаёт новый объект типа EventCaseDetails
...
func (e *EventCaseDetails) SetAnyEndDate(i any) {
...
func (e *EventCaseDetails) SetAnyResolutionStatus(i any) {
...
func (e *EventCaseDetails) SetAnySummary(i any) {
...
// SetAnyStatus статус
func (e *EventCaseDetails) SetAnyStatus(i any) {
...
func (e *EventCaseDetails) SetAnyImpactStatus(i any) {
